...
fn main() {
    ...
    let expected_n_risk = vec![
        vec![4.0, 0.0, 0.0, 0.0],  // At time 2
        vec![4.0, 1.0, 0.0, 0.0],  // At time 3
        vec![3.0, 1.0, 0.0, 0.0],  // At time 4
        vec![2.0, 2.0, 0.0, 0.0],  // At time 5
        vec![1.0, 2.0, 1.0, 0.0],  // At time 8
        vec![0.0, 1.0, 2.0, 1.0],  // At time 9
        vec![0.0, 0.0, 1.0, 0.0],  // At time 10
        vec![0.0, 0.0, 0.0, 0.0],  // At time 11
    ];
